        ...
        <div className="p-4 px-[10%] sm:px-[10%] md:px-[15%] lg:px-[20%] flex flex-col">
            <section>
                ...
                <p className="text-dark-grey text-md">
                    Programming and Development student | Web developer | Mobile
                    developer | C seminar tutor && code reviewer | Python code
                    reviewer
                </p>
            ...
            <section className="text-left grid gap-4">
                <article>
                    ...
                    <p className="text-lg">
                        ...
                        University in Brno. I have recently started doing the
                        third year of my studies. I am really passionate about
                    ...
                    <p className="text-lg">
                        ...
                        now, however, I never stick to one field as I try to be
                    ...
                    <p className="text-lg">
                        ...
                        interesting to me or if you have any questions do not
                        hesitate to{" "}
                        <a
