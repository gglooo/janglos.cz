...
export const projects: Project[] = [
    {
        id: "reservation-ticketing-system",
    ...
    {
        id: "project-manager-desktop-app",
    ...
    {
        id: "cicd-pipeline-for-react-native-apps",
